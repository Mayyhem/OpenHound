...
def test_transforms_graph_edges_always_created():
    ...
    With no site sources, site_hierarchy is empty and _graph_edges produces zero
    replication rows — but the table itself must be created so convert can read it
