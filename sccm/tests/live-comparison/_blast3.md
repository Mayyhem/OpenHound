...
- **CMBP console:** `C:\Users\domainadmin\Desktop\OpenHound\sccm\tests\live-comparison\results\openhound_sam_run.log`
- **OpenHound console:** `C:\Users\domainadmin\Desktop\OpenHound\sccm\tests\live-comparison\results\openhound_ac_run.log`
...
- **Regressions (CMBP PASS → OpenHound not PASS): 0**
- OpenHound-only passes (CMBP not PASS → OpenHound PASS): 5
- Both FAIL: 13
- Agree PASS: 42
...
|---|---|---|---|---|
| 47 | `SCCM_AssignAllPermissions` | SCCM primary site databases (CAS-DB\CM_CAS and PS1-DB\CM_PS1) can assign all permission... | FAIL (wrong count) | PASS |
| 53 | `SCCM_HasADLastLogonUser` | The PS1 client device has domainuser as the last logged on user in Active Directory | FAIL (not found) | PASS |
| 54 | `SCCM_HasClient` | PS1-DEV is a client of the PS1 site | FAIL (not found) | PASS |
| 56 | `SCCM_HasMember` | The SMS00001 collection contains the PS1 client device | FAIL (not found) | PASS |
| 57 | `SCCM_HasPrimaryUser` | The PS1 client device has domainuser as the primary user | FAIL (not found) | PASS |

### Failing in both

| # | Kind | Description | CMBP | OpenHound |
|---|---|---|---|---|
| 9 | `CoerceAndRelayToAdminService` | Authenticated Users group can coerce the PS1 primary site server and relay authenticati... | FAIL (not found) | FAIL (not found) |
| 10 | `CoerceAndRelayToMSSQL` | Authenticated Users group can coerce and relay authentication to the MSSQL service on t... | FAIL (not found) | FAIL (not found) |
| 11 | `CoerceAndRelayToMSSQL` | Authenticated Users group can coerce and relay authentication to the MSSQL service on t... | FAIL (not found) | FAIL (not found) |
| 12 | `CoerceAndRelayToMSSQL` | Authenticated Users group can coerce and relay authentication to the MSSQL service on t... | FAIL (not found) | FAIL (not found) |
| 13 | `CoerceAndRelayToMSSQL` | Authenticated Users group can coerce and relay authentication to the MSSQL service on t... | FAIL (not found) | FAIL (not found) |
| 14 | `CoerceAndRelayToSMB` | Authenticated Users group can coerce and relay authentication to the SMB service on the... | FAIL (not found) | FAIL (not found) |
| 15 | `CoerceAndRelayToSMB` | Authenticated Users group can coerce and relay authentication to the SMB service on the... | FAIL (not found) | FAIL (not found) |
| 16 | `CoerceAndRelayToSMB` | Authenticated Users group can coerce and relay authentication to the SMB service on the... | FAIL (not found) | FAIL (not found) |
...
| 58 | `SCCM_IsAssigned` | The domainadmin SCCM admin user is assigned the Full Administrator security role in the... | FAIL (wrong count) | FAIL (wrong count) |
| 59 | `SCCM_IsMappedTo` | The domainadmin user is mapped to an SCCM admin user in the CAS primary site (plus one ... | FAIL (wrong count) | FAIL (wrong count) |

## Per-edge-kind rollup (PASS / FAIL / SKIP)

| Kind | CMBP P/F/S | OpenHound P/F/S |
|---|---|---|
| `CoerceAndRelayToAdminService` | 0/1/0 | 0/1/0 |
| `CoerceAndRelayToMSSQL` | 0/4/0 | 0/4/0 |
| `CoerceAndRelayToSMB` | 0/4/0 | 0/4/0 |
| `HasSession` | 2/0/0 | 2/0/0 |
| `LocalAdminRequired` | 9/0/0 | 9/0/0 |
| `MSSQL_Contains` | 9/0/0 | 9/0/0 |
| `MSSQL_ControlDB` | 1/0/0 | 1/0/0 |
| `MSSQL_ControlServer` | 1/0/0 | 1/0/0 |
| `MSSQL_ExecuteOnHost` | 1/0/0 | 1/0/0 |
| `MSSQL_GetAdminTGS` | 1/0/0 | 1/0/0 |
| `MSSQL_GetTGS` | 1/0/0 | 1/0/0 |
| `MSSQL_HasLogin` | 1/0/0 | 1/0/0 |
| `MSSQL_HostFor` | 1/0/0 | 1/0/0 |
...
| `SCCM_AssignAllPermissions` | 1/1/0 | 2/0/0 |
| `SCCM_AssignSpecificPermissions` | 0/0/1 | 0/0/1 |
| `SCCM_Contains` | 3/0/0 | 3/0/0 |
| `SCCM_FullAdministrator` | 0/1/0 | 0/1/0 |
| `SCCM_HasADLastLogonUser` | 0/1/0 | 1/0/0 |
| `SCCM_HasClient` | 0/1/0 | 1/0/0 |
| `SCCM_HasCurrentUser` | 0/1/0 | 0/1/0 |
| `SCCM_HasMember` | 0/1/0 | 1/0/0 |
| `SCCM_HasPrimaryUser` | 0/1/0 | 1/0/0 |
| `SCCM_IsAssigned` | 0/1/0 | 0/1/0 |
| `SCCM_IsMappedTo` | 1/1/0 | 1/1/0 |
...
|---|---|---|
| `HasSession` | 8 | 8 |
| `LocalAdminRequired` | 14 | 14 |
| `MSSQL_Contains` | 17 | 17 |
| `MSSQL_ControlDB` | 3 | 3 |
| `MSSQL_ControlServer` | 3 | 3 |
| `MSSQL_ExecuteOnHost` | 3 | 3 |
| `MSSQL_GetAdminTGS` | 2 | 2 |
| `MSSQL_GetTGS` | 4 | 4 |
| `MSSQL_HasLogin` | 4 | 4 |
| `MSSQL_HostFor` | 3 | 3 |
| `MSSQL_IsMappedTo` | 4 | 4 |
| `MSSQL_MemberOf` | 8 | 8 |
| `MSSQL_ServiceAccountFor` | 2 | 2 |
| `MemberOf` | 79 | 79 |
| `SCCM_AdminsReplicatedTo` | 3 | 3 |
| `SCCM_AllPermissions` | 2 | 2 |
| `SCCM_ApplicationAdministrator` | 19 | 19 |
| `SCCM_AssignAllPermissions` | 14 | 10 |
| `SCCM_Contains` | 60 | 60 |
| `SCCM_FullAdministrator` | 19 | 19 |
| `SCCM_HasADLastLogonUser` | 14 | 14 |
| `SCCM_HasClient` | 19 | 19 |
| `SCCM_HasCurrentUser` | 6 | 6 |
| `SCCM_HasMember` | 43 | 43 |
| `SCCM_HasPrimaryUser` | 1 | 1 |
| `SCCM_HasStoredAccount` | 2 | 2 |
| `SCCM_IsAssigned` | 9 | 9 |
| `SCCM_IsMappedTo` | 3 | 3 |
| `SameHostAs` | 38 | 38 |
...
| 9 | `CoerceAndRelayToAdminService` | Authenticated Users group can coerce the PS1 primary site server an... | FAIL (not found) | FAIL (not found) | both FAIL |
| 10 | `CoerceAndRelayToMSSQL` | Authenticated Users group can coerce and relay authentication to th... | FAIL (not found) | FAIL (not found) | both FAIL |
| 11 | `CoerceAndRelayToMSSQL` | Authenticated Users group can coerce and relay authentication to th... | FAIL (not found) | FAIL (not found) | both FAIL |
| 12 | `CoerceAndRelayToMSSQL` | Authenticated Users group can coerce and relay authentication to th... | FAIL (not found) | FAIL (not found) | both FAIL |
| 13 | `CoerceAndRelayToMSSQL` | Authenticated Users group can coerce and relay authentication to th... | FAIL (not found) | FAIL (not found) | both FAIL |
| 14 | `CoerceAndRelayToSMB` | Authenticated Users group can coerce and relay authentication to th... | FAIL (not found) | FAIL (not found) | both FAIL |
| 15 | `CoerceAndRelayToSMB` | Authenticated Users group can coerce and relay authentication to th... | FAIL (not found) | FAIL (not found) | both FAIL |
| 16 | `CoerceAndRelayToSMB` | Authenticated Users group can coerce and relay authentication to th... | FAIL (not found) | FAIL (not found) | both FAIL |
...
| 28 | `MSSQL_Contains` | The MSSQL servers (cas-db, ps1-db, and ps1-psv) contain the sysadmi... | PASS | PASS |  |
| 29 | `MSSQL_ControlDB` | The db_owner MSSQL database role controls the site database on cas-... | PASS | PASS |  |
| 30 | `MSSQL_ControlServer` | The sysadmin MSSQL server role controls the server instance on cas-... | PASS | PASS |  |
| 31 | `MSSQL_ExecuteOnHost` | The MSSQL servers (cas-db, ps1-db, and ps1-psv) can execute command... | PASS | PASS |  |
...
| 35 | `MSSQL_HostFor` | The MSSQL server computers (cas-db, ps1-db, and ps1-psv) host the M... | PASS | PASS |  |
...
| 47 | `SCCM_AssignAllPermissions` | SCCM primary site databases (CAS-DB\CM_CAS and PS1-DB\CM_PS1) can a... | FAIL (wrong count) | PASS | ⚠️ OH-only pass |
...
| 53 | `SCCM_HasADLastLogonUser` | The PS1 client device has domainuser as the last logged on user in ... | FAIL (not found) | PASS | ⚠️ OH-only pass |
| 54 | `SCCM_HasClient` | PS1-DEV is a client of the PS1 site | FAIL (not found) | PASS | ⚠️ OH-only pass |
...
| 56 | `SCCM_HasMember` | The SMS00001 collection contains the PS1 client device | FAIL (not found) | PASS | ⚠️ OH-only pass |
| 57 | `SCCM_HasPrimaryUser` | The PS1 client device has domainuser as the primary user | FAIL (not found) | PASS | ⚠️ OH-only pass |
| 58 | `SCCM_IsAssigned` | The domainadmin SCCM admin user is assigned the Full Administrator ... | FAIL (wrong count) | FAIL (wrong count) | both FAIL |
| 59 | `SCCM_IsMappedTo` | The domainadmin user is mapped to an SCCM admin user in the CAS pri... | FAIL (wrong count) | FAIL (wrong count) | both FAIL |
