...
- **OpenHound console:** `C:\Users\domainadmin\Desktop\OpenHound\sccm\tests\live-comparison\results\openhound_pe_run.log`
...
- **Regressions (CMBP PASS → OpenHound not PASS): 25**
...
| `CoerceAndRelayToMSSQL` | 4/0/0 | 1/3/0 |
| `CoerceAndRelayToSMB` | 3/1/0 | 2/2/0 |
...
| `CoerceAndRelayToMSSQL` | 5 | 1 |
| `CoerceAndRelayToSMB` | 5 | 3 |
| `HasSession` | 9 | 8 |
