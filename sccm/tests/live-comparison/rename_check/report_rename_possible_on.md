...
- **CMBP console:** `results\live_run.log`
- **OpenHound console:** `rename_check\possible_on\openhound_renamed_possible_on_run.log`
...
|---|---|---|
| `CoerceAndRelayToAdminService` | 1/0/0 | 0/0/0 |
| `CoerceAndRelayToMSSQL` | 4/0/0 | 0/0/0 |
| `CoerceAndRelayToSMB` | 3/1/0 | 0/0/0 |
| `HasSession` | 2/0/0 | 2/0/0 |
| `LocalAdminRequired` | 9/0/0 | 0/0/0 |
| `MSSQL_CoerceAndRelayToMSSQL` | 0/0/0 | 4/0/0 |
...
| `SCCM_CoerceAndRelayToAdminService` | 0/0/0 | 1/0/0 |
| `SCCM_CoerceAndRelayToSMB` | 0/0/0 | 3/1/0 |
...
| `SCCM_LocalAdminRequired` | 0/0/0 | 9/0/0 |
| `SCCM_SameHostAs` | 0/0/0 | 2/0/0 |
| `SameHostAs` | 2/0/0 | 0/0/0 |
...
| `HasSession` | 9 | 9 |
| `LocalAdminRequired` | 13 | 0 |
| `MSSQL_CoerceAndRelayToMSSQL` | 0 | 4 |
