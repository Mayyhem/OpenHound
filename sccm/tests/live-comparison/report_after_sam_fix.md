...
- **OpenHound console:** `C:\Users\domainadmin\Desktop\OpenHound\sccm\tests\live-comparison\results\openhound_sam_run.log`
...
- **Regressions (CMBP PASS → OpenHound not PASS): 15**
