...
- **OpenHound console:** `C:\Users\domainadmin\Desktop\OpenHound\sccm\tests\live-comparison\results\openhound_fresh_run.log`
...
- **Regressions (CMBP PASS → OpenHound not PASS): 20**
