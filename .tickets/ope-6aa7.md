...
Done + committed (efb3d1c 'Move AD nodes/edges to separate file without source_kind'): opengraph_untagged.py + transforms._graph_edges_split + AD_NODE_SPECS/AD_EDGE_SPECS + two-pass convert emit all present.
